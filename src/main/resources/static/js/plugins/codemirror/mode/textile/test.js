...
(function() {
  ...
  MT('divWithAttribute',
      '[punctuation div][punctuation&attribute (#archive-id)][punctuation . foo bar]');

  MT('divWithAttributeAnd2emRightPadding',
      '[punctuation div][punctuation&attribute (#archive-id)((][punctuation . foo bar]');

  MT('divWithClassAndId',
      '[punctuation div][punctuation&attribute (archive-class#archive-id)][punctuation . foo bar]');
  ...
  MT('phraseModifierAttributes',
      'p[attribute (archive-class)]. This is a paragraph that has a class and' +
      ' this [em _][em&attribute (#special-phrase)][em emphasized phrase_]' +
      ' has an id.');

  MT('linkWithClass',
      '[link "(archive-class). This is a link with class":http://redcloth.org]');
  ...
  MT('inlineHtml',
      'I can use HTML directly in archive [comment <span class="youbetcha">Textile</span>].');
